...
alias v='export NVIM_APPNAME="neobean" && /usr/local/opt/neovim'
alias vq='export NVIM_APPNAME="quarto-nvim-kickstarter" && /usr/local/opt/neovim'
alias vk='export NVIM_APPNAME="kickstart.nvim" && /usr/local/opt/neovim'
alias vl='export NVIM_APPNAME="lazyvim" && /usr/local/opt/neovim'
...
alias nvim='export NVIM_APPNAME="nvim" && /usr/local/opt/neovim'
